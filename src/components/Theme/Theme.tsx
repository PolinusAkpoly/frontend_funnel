/*
  ...
  Created At : 27/01/2024 12:54:51
*/
...
const Theme: FC<ThemeProps> = () => {
  ...
  const [theme, setTheme] = useState<string>(() => {
    // Initialisez le thème en fonction de la valeur stockée dans localStorage, ou "auto" par défaut
    return localStorage.getItem('theme') || 'auto';
  });

  useEffect(() => {
    // Ajoutez votre logique ici pour gérer le changement de thème
    const handleThemeChange = () => {
      document.documentElement.setAttribute('data-bs-theme', theme);
      localStorage.setItem('theme', theme);
    };

    // Appliquez le thème initial lors du premier rendu
    handleThemeChange();
  ...
  }, [theme]); // Incluez 'theme' en tant que dépendance si nécessaire
          ...
          <ul className="dropdown-menu dropdown-menu-end shadow" aria-labelledby="bd-theme-text">
            <li>
              ...
              data-bs-theme-value="light" aria-pressed="false">
                ...
                Light
                {theme === 'light' && <svg className="bi ms-auto" width="1em" height="1em"><use href="#check" /></svg>}
              </button>
            </li>
            <li>
              ...
              data-bs-theme-value="dark" aria-pressed="false">
                ...
                Dark
                {theme === 'dark' && <svg className="bi ms-auto" width="1em" height="1em"><use href="#check" /></svg>}
              </button>
            </li>
            <li>
              ...
              data-bs-theme-value="auto" aria-pressed="true">
                ...
                Auto
                {theme === 'auto' && <svg className="bi ms-auto" width="1em" height="1em"><use href="#check" /></svg>}
              </button>
            </li>
          </ul>
        </div>
